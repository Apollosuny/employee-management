...
<header class="">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo $user['role'] == 'employee' ? _WEB_ROOT.'/dashboard' : _WEB_ROOT.'/admin/adminpanel' ?>">
                <img src="<?php echo _WEB_ROOT; ?>/public/assets/images/logo.png    " style="" />
            </a>
                    ...
                    <li class="nav-item d-flex justify-content-between align-items-center" style="gap: 20px">
                        <div>
                            <form method="POST" action="<?php echo _WEB_ROOT; ?>/auth/logout">
                                <button class="dropdown-item hover" type="submit">Logout</button>
                            </form>
                        </div>

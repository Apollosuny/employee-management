...
<link rel="stylesheet" href="<?php echo _WEB_ROOT; ?>/public/assets/css/signin.css" type="text/css" media="all" /> <!-- Style-CSS --> 
<link rel="stylesheet" href="<?php echo _WEB_ROOT; ?>/public/assets/css/signup.css" type="text/css" media="all" /> <!-- Style-CSS --> 
<!-- //css files -->
<!-- web-fonts -->
